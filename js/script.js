...
const translations = {
  sk: {
    ...
    'about.label': 'O mne',
    'about.photoPlaceholder': 'Vaša fotka',
    'about.heading': 'Praktický prístup k zlepšovaniu procesov',
    'about.body1': 'Zameriavam sa na to, aby firmy mali jasnú víziu, jednoduché procesy bez plytvania a čo najviac automatizovaných opakujúcich sa činností. Kombinujem manažérske rámce, Lean a Six Sigma techniky a moderné automatizačné nástroje do riešení, ktoré fungujú v reálnej prevádzke.',
    'about.body2': '[Doplňte krátky profesijný životopis — roky praxe, certifikácie, odvetvia, v ktorých ste pôsobili.]',
    ...
    'services.automation.title': 'AI Agentická Automatizácia',
  ...
  en: {
    ...
    'about.body1': 'I focus on giving companies a clear vision, simple waste-free processes, and as much automation of repetitive work as possible. I combine management frameworks, Lean and Six Sigma techniques, and modern automation tools into solutions that work in real operations.',
    'about.body2': '[Add a short professional bio — years of experience, certifications, industries you have worked in.]',
    ...
    'services.sixsigma.tag2': 'Process control',
    'services.sixsigma.tag3': 'Root-cause analysis of variability',
    'services.automation.title': 'AI Agentic Automation',
