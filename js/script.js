...
const translations = {
  sk: {
    ...
    'cases.case1.metric': '9 000 → <600 ks',
    'cases.case1.metricLabel': 'backlog opráv za 9 mesiacov',
    'cases.case1.title': 'Backlog v servise elektroniky pre OEM výrobcov',
    'cases.case1.body': 'Na sklade čakalo na opravu približne 9 000 zariadení, mnohé viac ako pol roka. Z dát o modeloch a typoch opráv sme vypočítali potrebnú kapacitu, zabezpečili materiál, preškolili ľudí a vytvorili samostatnú skupinu na backlog, bez straty kapacity pre bežné opravy. Zamerali sme sa aj na kvalitu, pretože pri internej chybovosti 5–6 % treba o toľko vyššiu kapacitu. Za 5 mesiacov klesol backlog na 2 000 kusov a za 9 mesiacov pod 600.',
