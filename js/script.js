...
const translations = {
  sk: {
    ...
    'cases.lean.body': 'V tej istej pobočke sme zmenili organizáciu práce na pracovisku. Zaviedli sme kombináciu one-piece flow a dávkového spracovania (batch flow), metodiku 5S a výraznú vizualizáciu výrobného prostredia, aby bol stav práce viditeľný na prvý pohľad. Servisná kapacita na niektorých pozíciách vzrástla až 4× a celá servisná činnosť sa zefektívnila.',
  ...
  en: {
    ...
    'cases.lean.body': 'In the same branch we reorganised the work on the shop floor. We introduced a combination of one-piece flow and batch flow, 5S and strong visual management of the production floor, so the status of work was visible at a glance. Service capacity in some roles increased up to 4×, and the service operation as a whole became more efficient.',
