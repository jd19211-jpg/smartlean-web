...
const translations = {
  sk: {
    ...
    'cases.management.body': 'Centrála (HQ) sa na mňa obrátila s požiadavkou dostať pobočku, ktorá bola dlhodobo v mínuse, späť do čiernych čísel. Kľúčom bola zmena spôsobu myslenia a riadenia: zaviedli sme pravidelné plánovanie a vizuálny manažment, aby tímy videli plán aj skutočný výkon. Prevádzkové náklady klesli a počet FTE sa znížil o 20 %. Do 4 mesiacov sa pobočka dostala zo straty do zisku.',
  ...
  en: {
    ...
    'cases.management.body': 'Headquarters asked me to bring a branch that had been in the red for a long time back into the black. The key was changing how people thought and how the branch was managed: we introduced regular planning and visual management so teams could see both the plan and actual performance. Operating costs went down and headcount (FTE) was reduced by 20%. Within 4 months the branch went from loss to profit.',
