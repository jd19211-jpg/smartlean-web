...
const translations = {
  sk: {
    ...
    'services.management.quote': '„Úlohou managementu je nájsť ‚core of the core‘ toho, čo je pre firmu dôležité. Všetko ostatné je balast.“',
    ...
    'services.automation.quote': '„Automatizácia a AI agenti nenahrádzajú ľudí. Robia prácu, ktorú nepotrebujú robiť ľudia.“',
    ...
    'cases.case2.metric': '9 000 → <600 ks',
    'cases.case2.metricLabel': 'backlog opráv za 9 mesiacov',
    'cases.case2.title': 'Backlog v servise elektroniky pre OEM výrobcov',
    'cases.case2.body': 'Na sklade čakalo na opravu približne 9 000 zariadení, mnohé viac ako pol roka. Z dát o modeloch a typoch opráv sme vypočítali potrebnú kapacitu, zabezpečili materiál, preškolili ľudí a vytvorili samostatnú skupinu na backlog, bez straty kapacity pre bežné opravy. Zamerali sme sa aj na kvalitu, pretože pri internej chybovosti 5–6 % treba o toľko vyššiu kapacitu. Za 5 mesiacov klesol backlog na 2 000 kusov a za 9 mesiacov pod 600.',
  ...
  en: {
    ...
    'services.management.quote': '"The job of management is to find the \'core of the core\' of what matters to the company. Everything else is ballast."',
    ...
    'services.automation.quote': '"Automation and AI agents don\'t replace people. They do the work people don\'t need to do."',
