...
const translations = {
  ...
  en: {
    ...
    'cases.ai.metric': '~2,000 h',
    'cases.ai.metricLabel': 'of manual work saved per year',
    'cases.ai.title': 'RPA robots and an AI assistant instead of routine',
    'cases.ai.body': 'RPA robots took over repetitive manual tasks and saved around 2,000 hours of work per year, freeing people for work that needs their judgement. Website visitors are handled by an AI assistant: it answers questions, checks for a free slot in the calendar and, once confirmed, books the meeting and sends the invitation on its own. Try it in the bottom right corner.',
