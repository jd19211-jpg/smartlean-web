...
const translations = {
  ...
  en: {
    ...
    'cases.lean.body': 'In the same branch the individual roles were set up properly and the work was simplified, which put less pressure on skills and raised output quality. We created one-piece + batch flow, strong visualisation of the production environment and introduced 5S. Service capacity in some roles increased up to 4× and service operations became more efficient.',
