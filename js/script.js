...
const translations = {
  sk: {
    ...
    'cases.ai.body': 'Pomocou RPA sa ušetrilo cca 2 000 hodín ročne na manuálnej práci prepisovania dát z jedného systému do iného. Neboli pripravené dátové prepoje, žiadne API ani direct volanie, aj keď to boli systémy v jednej firme. Asistent 24/7 na tomto webe odpovedá na otázky, overí voľný termín v kalendári a po potvrdení zarezervuje stretnutie. Vyskúšajte ho vpravo dole.',
  ...
  en: {
    ...
    'cases.ai.body': 'RPA saved approx. 2,000 hours a year of manual work retyping data from one system into another. There were no data connections, no API and no direct calls, even though the systems were in the same company. The 24/7 assistant on this website answers questions, checks a free slot in the calendar and, once confirmed, books the meeting. Try it in the bottom right corner.',
