...
const translations = {
  sk: {
    ...
    'cases.ai.title': 'RPA a AI asistent 24/7',
    'cases.ai.body': 'Systémy vo firme spolu nekomunikovali. Neboli pripravené dátové prepoje, žiadne API ani direct volanie, a tak ľudia prepisovali dáta z jedného systému do druhého ručne. Ročne to bolo okolo 2 000 hodín zbytočnej práce. Dnes to kompletne robia RPA roboty a tím sa môže venovať zmysluplnejšej práci. Samostatným projektom je AI asistent, ktorý funguje 24/7. Overuje termíny, plánuje stretnutia a odpovedá návštevníkom bez toho, aby musel niekto zdvíhať telefón. Ako funguje v praxi, si môžete vyskúšať priamo tu na webe vpravo dole.',
    'cases.management.metric': '4 mesiace',
    'cases.management.metricLabel': 'zo straty do zisku',
    'cases.management.title': 'Pobočka späť v čiernych číslach',
    'cases.management.body': 'HQ sa na mňa obrátil s požiadavkou vrátiť ich pobočku, ktorá bola dlhodobo v mínuse, späť do čiernych čísel. Išlo o transformáciu firmy, o zmenu myslenia, zavedenie plánovania a visual managementu. Nastavili sme presný denný plán a dohliadali na jeho dodržiavanie. Ak vznikali odchýlky, riešili sme to okamžite. Znížili sme OPEX náklady (−20 % redukcia FTE) a do 4 mesiacov bola pobočka v zisku.',
    'cases.lean.metric': 'až 4×',
    'cases.lean.metricLabel': 'vyššia servisná kapacita na niektorých pozíciách',
    'cases.lean.title': 'Efektívnejšia servisná činnosť',
    'cases.lean.body': 'Správne sa nastavili jednotlivé pozície a zjednodušila sa práca, čo vytváralo menší tlak na zručnosti a zvýšilo to kvalitu výstupu. Vytvorili sme one piece + batch flow, silnú vizualizáciu produkčného prostredia a zaviedli metodiku 5S. Servisná kapacita sa na niektorých pozíciách zvýšila až 4× a servisná činnosť sa zefektívnila.',
    'cases.lean.subhead2': 'Rozšírenie skladu na 3×',
    'cases.lean.body2': 'Sklad bol držaný len na podlahe a cca 20 rokov to bol štandard. Palety neboli označené, vyznal sa v nich len jeden človek. Viac materiálu sa nedalo objednať, pretože nebolo kde uskladniť. Prepočítal som a navrhol 3 možnosti a zrealizovali sme tú, kde sklad využitím RACK systému 3× zvýšil kapacitu. Firma je efektívnejšia, má viac priestoru na ďalší rozvoj za veľmi prijateľné náklady. Postupne môže sklad rozširovať podľa potreby. Nebola potrebná plná investícia od začiatku.',
    'cases.sixsigma.metric': '9 000 → <600 ks',
    'cases.sixsigma.metricLabel': 'backlog opráv za 9 mesiacov',
    'cases.sixsigma.title': 'Zníženie backlogu opráv',
    'cases.sixsigma.body': 'Na sklade bolo cca 9 000 zariadení, ktoré tam už viac ako pol roka „sedeli“ a čakali na opravu. Použili sme metodiku Pareto k identifikácii modelov, objednaniu materiálu a výpočtu kapacity na základe týchto dát. Preškolili sme ľudí a vytvorili špeciálnu skupinu, ktorá sa tomu venovala, a zároveň sme neznížili kapacitu štandardnej opravy. Denne sme určili počet opráv, ktoré musia byť hotové. Sklad mal za úlohu byť 100 % pripravený s objednávkami a materiálom. Plán bol do 5 mesiacov znížiť backlog na 2 000 ks, čo bola akceptovateľná hranica. Postupne sme ho ešte znižovali a po 9 mesiacoch sme boli pod 600 ks. Potrebné bolo aj zvýšiť kvalitu servisu, pretože opakované interné opravy znižujú výstupnú kapacitu. Ak je internal failure rate 5–6 %, musím mať o toľko vyššiu kapacitu.',
  ...
  en: {
    ...
    'cases.ai.title': 'RPA and a 24/7 AI assistant',
    'cases.ai.body': 'The company\'s systems did not talk to each other. There were no data connections, no API and no direct calls, so people retyped data from one system into another by hand. That was around 2,000 hours of pointless work a year. Today RPA robots do it entirely, and the team can focus on more meaningful work. A separate project is an AI assistant that works 24/7. It checks availability, schedules meetings and answers visitors without anyone having to pick up the phone. You can try how it works in practice right here on the website, in the bottom right corner.',
    'cases.management.metric': '4 months',
    'cases.management.metricLabel': 'from loss to profit',
    'cases.management.title': 'A branch back in the black',
    'cases.management.body': 'HQ asked me to bring their branch, which had been in the red for a long time, back into the black. It was about transforming the company, changing the mindset, and introducing planning and visual management. We set a precise daily plan and made sure it was followed. When deviations came up, we dealt with them immediately. We reduced OPEX (−20% FTE reduction) and within 4 months the branch was in profit.',
    'cases.lean.metric': 'up to 4×',
    'cases.lean.metricLabel': 'higher service capacity in some roles',
    'cases.lean.title': 'More efficient service operations',
    'cases.lean.body': 'The individual roles were set up properly and the work was simplified, which put less pressure on skills and raised output quality. We created one-piece + batch flow, strong visualisation of the production environment and introduced 5S. Service capacity in some roles increased up to 4× and service operations became more efficient.',
    'cases.lean.subhead2': 'Warehouse capacity expanded 3×',
    'cases.lean.body2': 'The warehouse was kept on the floor only, and that had been the standard for about 20 years. Pallets were not labelled and only one person knew his way around them. More material could not be ordered because there was nowhere to store it. I did the calculations and proposed 3 options, and we implemented the one where a rack system increased warehouse capacity 3×. The company is more efficient and has room for further growth at a very acceptable cost. The warehouse can be expanded step by step as needed. No full investment was required up front.',
    'cases.sixsigma.metric': '9,000 → <600 units',
    'cases.sixsigma.metricLabel': 'repair backlog in 9 months',
    'cases.sixsigma.title': 'Reducing the repair backlog',
    'cases.sixsigma.body': 'There were approx. 9,000 devices in the warehouse that had been "sitting" there for more than six months waiting for repair. We used the Pareto method to identify the models, order material and calculate capacity based on this data. We retrained people and set up a special team dedicated to it, while not reducing the capacity for standard repairs. Every day we set the number of repairs that had to be finished. The warehouse had to be 100% ready with orders and material. The plan was to cut the backlog to 2,000 units within 5 months, which was the acceptable limit. We kept reducing it and after 9 months we were under 600 units. We also had to raise service quality, because repeated internal repairs reduce output capacity. If the internal failure rate is 5–6%, I need that much more capacity.',
