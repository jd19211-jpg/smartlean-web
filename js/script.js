...
const translations = {
  sk: {
    ...
    'cases.lean.body': 'V tej istej pobočke sme správne nastavili jednotlivé pozície a zjednodušili prácu. Práca tak vyžadovala menej zručností a zvýšila sa kvalita výstupu. Zaviedli sme one-piece flow v kombinácii s batch flow, 5S a vizualizáciu pracoviska. Servisná kapacita na niektorých pozíciách vzrástla až 4×.',
  ...
  en: {
    ...
    'cases.lean.body': 'In the same branch we set up each role properly and simplified the work. It required fewer specialised skills and output quality went up. We introduced one-piece flow combined with batch flow, 5S and visual management of the workplace. Service capacity in some roles increased up to 4×.',
