...
const translations = {
  sk: {
    ...
    'cases.management.title': 'Transformácia stratovej pobočky',
    'cases.management.body': 'Centrála (HQ) sa na mňa obrátila s požiadavkou dostať pobočku, ktorá bola dlhodobo v mínuse, späť do čiernych čísel. Kľúčom bola zmena spôsobu myslenia a riadenia. Nastavili sme presný denný plán a dohliadali na jeho dodržiavanie. Vďaka vizuálnemu manažmentu tímy videli plán aj skutočný výkon a keď vznikli odchýlky, riešili sme ich okamžite. Prevádzkové náklady klesli a počet FTE sa znížil o 20 %. Do 4 mesiacov sa pobočka dostala zo straty do zisku.',
    ...
    'cases.lean.body': 'V tej istej pobočke sme správne nastavili jednotlivé pozície a zjednodušili prácu, takže kládla menšie nároky na zručnosti a zvýšila sa kvalita výstupu. Zaviedli sme kombináciu one-piece flow a dávkového spracovania (batch flow), metodiku 5S a výraznú vizualizáciu výrobného prostredia, aby bol stav práce viditeľný na prvý pohľad. Servisná kapacita na niektorých pozíciách vzrástla až 4× a celá servisná činnosť sa zefektívnila.',
  ...
  en: {
    ...
    'cases.management.title': 'Turning around a loss-making branch',
    'cases.management.body': 'Headquarters asked me to bring a branch that had been in the red for a long time back into the black. The key was changing how people thought and how the branch was managed. We set a precise daily plan and made sure it was followed. Visual management let teams see both the plan and actual performance, and whenever deviations appeared, we dealt with them immediately. Operating costs went down and headcount (FTE) was reduced by 20%. Within 4 months the branch went from loss to profit.',
    ...
    'cases.lean.body': 'In the same branch we set up each role properly and simplified the work, which put less pressure on individual skills and raised output quality. We introduced a combination of one-piece flow and batch flow, 5S and strong visual management of the production floor, so the status of work was visible at a glance. Service capacity in some roles increased up to 4×, and the service operation as a whole became more efficient.',
