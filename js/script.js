...
const translations = {
  sk: {
    ...
    'cases.lean.title': 'Viditeľný proces, vyšší výkon',
    'cases.lean.body': 'V tej istej firme sme zmenili organizáciu práce na pracovisku. Zaviedli sme kombináciu one-piece flow a dávkového spracovania (batch flow), metodiku 5S a výraznú vizualizáciu výrobného prostredia, aby bol stav práce viditeľný na prvý pohľad. Produktivita na niektorých pozíciách vzrástla až 4×.',
  ...
  en: {
    ...
    'cases.lean.title': 'A visible process, higher output',
    'cases.lean.body': 'In the same company we reorganised the work on the shop floor. We introduced a combination of one-piece flow and batch flow, 5S and strong visual management of the production floor, so the status of work was visible at a glance. Productivity in some roles increased up to 4×.',
