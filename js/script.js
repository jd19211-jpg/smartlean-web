...
const translations = {
  sk: {
    ...
    'cases.ai.metric': '[napr. -30 %]',
    'cases.ai.metricLabel': '[čo sa zlepšilo]',
    'cases.ai.title': '[Názov projektu / klient]',
    'cases.ai.body': '[Opíšte, aký problém ste riešili, čo ste urobili a aký bol výsledok — 2 až 3 vety.]',
    'cases.management.metric': '4 mesiace',
    'cases.management.metricLabel': 'zo straty do zisku',
    'cases.management.title': 'Transformácia firmy v oblasti opráv elektroniky',
    'cases.management.body': 'Firma zameraná na opravy a repasovanie elektroniky bola v strate. Najväčšia zmena bola v spôsobe myslenia a riadenia. Zaviedli sme plánovanie, kombináciu one-piece a batch flow, výraznú vizualizáciu výrobného prostredia a metodiku 5S. Počet FTE sme znížili o 20 % a produktivita na niektorých pozíciách vzrástla až 4×. Do 4 mesiacov sa firma dostala zo straty do zisku.',
    'cases.lean.metric': '9 000 → <600 ks',
    'cases.lean.metricLabel': 'backlog opráv za 9 mesiacov',
    'cases.lean.title': 'Backlog v servise elektroniky pre OEM výrobcov',
    'cases.lean.body': 'Na sklade čakalo na opravu približne 9 000 zariadení, mnohé viac ako pol roka. Z dát o modeloch a typoch opráv sme vypočítali potrebnú kapacitu, zabezpečili materiál, preškolili ľudí a vytvorili samostatnú skupinu na backlog, bez straty kapacity pre bežné opravy. Zamerali sme sa aj na kvalitu, pretože pri internej chybovosti 5–6 % treba o toľko vyššiu kapacitu. Za 5 mesiacov klesol backlog na 2 000 kusov a za 9 mesiacov pod 600.',
    'cases.sixsigma.metric': '[napr. -30 %]',
    'cases.sixsigma.metricLabel': '[čo sa zlepšilo]',
    'cases.sixsigma.title': '[Názov projektu / klient]',
    'cases.sixsigma.body': '[Opíšte, aký problém ste riešili, čo ste urobili a aký bol výsledok — 2 až 3 vety.]',
  ...
  en: {
    ...
    'cases.ai.metric': '[e.g. -30%]',
    'cases.ai.metricLabel': '[what improved]',
    'cases.ai.title': '[Project name / client]',
    'cases.ai.body': '[Describe the problem you solved, what you did, and the result — 2-3 sentences.]',
    'cases.management.metric': '4 months',
    'cases.management.metricLabel': 'from loss to profit',
    'cases.management.title': 'Transformation of an electronics repair company',
    'cases.management.body': 'A company specialising in electronics repair and refurbishment was losing money. The biggest change was in mindset and management. We introduced planning, a combination of one-piece and batch flow, strong visual management of the production floor and 5S. We reduced headcount (FTE) by 20%, and productivity in some roles increased up to 4×. Within 4 months the company went from loss to profit.',
    'cases.lean.metric': '9,000 → <600 units',
    'cases.lean.metricLabel': 'repair backlog in 9 months',
    'cases.lean.title': 'Repair backlog for OEM electronics',
    'cases.lean.body': 'Around 9,000 devices were waiting for repair, many for more than six months. Using data on models and repair types, we calculated the capacity needed, secured materials, retrained staff and set up a dedicated backlog team, without taking capacity away from standard repairs. We also focused on quality, because an internal failure rate of 5–6% requires that much extra capacity. Within 5 months the backlog dropped to 2,000 units, and within 9 months to under 600.',
    'cases.sixsigma.metric': '[e.g. -30%]',
    'cases.sixsigma.metricLabel': '[what improved]',
    'cases.sixsigma.title': '[Project name / client]',
    'cases.sixsigma.body': '[Describe the problem you solved, what you did, and the result — 2-3 sentences.]',
