...
const translations = {
  sk: {
    ...
    'cases.sixsigma.body': 'Na sklade bolo cca 9 000 zariadení, ktoré tam už viac ako pol roka „sedeli“ a čakali na opravu. Riešením bola dátová analýza, rozdelenie na modely a typy opráv, kapacitný výpočet, objednávky materiálu, preškolenie ľudí a vytvorenie špeciálnej skupiny, ktorá sa tomu venovala, a zároveň sme neznížili kapacitu štandardnej opravy. Plán bol do 5 mesiacov znížiť backlog na 2 000 ks, čo bola akceptovateľná hranica. Postupne sme ho ešte znižovali a po 9 mesiacoch sme boli pod 600 ks. Potrebné bolo aj zvýšiť kvalitu servisu, pretože opakované interné opravy znižujú výstupnú kapacitu. Ak je internal failure rate 5–6 %, musím mať o toľko vyššiu kapacitu.',
  ...
  en: {
    ...
    'cases.sixsigma.body': 'There were approx. 9,000 devices in the warehouse that had been "sitting" there for more than six months waiting for repair. The solution was data analysis, splitting by models and repair types, a capacity calculation, material orders, retraining people and setting up a special team dedicated to it, while not reducing the capacity for standard repairs. The plan was to cut the backlog to 2,000 units within 5 months, which was the acceptable limit. We kept reducing it and after 9 months we were under 600 units. We also had to raise service quality, because repeated internal repairs reduce output capacity. If the internal failure rate is 5–6%, I need that much more capacity.',
