...
const translations = {
  sk: {
    ...
    'cases.lean.metric': '4 × 3 nemusí byť 12',
    'cases.lean.metricLabel': '4× servisná kapacita vs. 3× kapacita skladu',
    'cases.lean.title': 'Efektívnejšia servisná činnosť',
    'cases.lean.body': 'Správne sme nastavili pozície a zjednodušili prácu. Znížili sa tým nároky na zručnosti personálu a zvýšila sa kvalita výstupu. Kombináciou one-piece a batch flow, metodikou 5S a silnou vizualizáciou prostredia sa servisná kapacita na niektorých pozíciách zvýšila až 4×.',
    'cases.lean.subhead2': 'Rozšírenie skladu na 3×',
    'cases.lean.body2': 'Ďalší projekt bol sklad. Palety sa 20 rokov skladovali len na podlahe, bez označenia, a vyznal sa v nich jediný človek. Viac materiálu sa nedalo objednať, pretože ho nebolo kde uskladniť. Prepočítal som to, navrhol tri možnosti a zrealizovali sme regálový (RACK) systém. Kapacita skladu sa hneď zvýšila 3× a nebola potrebná veľká investícia od začiatku. Sklad sa dá postupne rozširovať podľa potreby.',
  ...
  en: {
    ...
    'cases.lean.metric': '4 × 3 doesn’t have to be 12',
    'cases.lean.metricLabel': '4× service capacity vs. 3× warehouse capacity',
    'cases.lean.title': 'More efficient service operations',
    'cases.lean.body': 'We set up the roles properly and simplified the work. This reduced the skill demands on staff and raised output quality. By combining one-piece and batch flow, 5S and strong visual management, service capacity in some roles increased up to 4×.',
    'cases.lean.subhead2': 'Warehouse capacity expanded 3×',
    'cases.lean.body2': 'Another project was the warehouse. For 20 years pallets had been stored on the floor only, unlabelled, and just one person knew his way around them. More material could not be ordered because there was nowhere to store it. I did the calculations, proposed three options and we implemented a rack system. Warehouse capacity immediately increased 3× without a large up-front investment. The warehouse can be expanded step by step as needed.',
